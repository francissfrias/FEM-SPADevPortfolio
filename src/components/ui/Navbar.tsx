...
const Navbar = () => {
  return (
    ...
    >
      <a className='font-bold text-medium md:text-[32px] md:leading-8 md:-tracking-[0.44px] cursor-pointer hover:text-accent'>
        adamkeyes
      </a>
        ...
        <li className='group cursor-pointer'>
          <a>
            <svg
              ...
              width='25'
              height='24'
              className='md:min-w-[24.61px] '
            >
              <path
                className='group-hover:text-accent group-hover:fill-accent'
                fill='#FFF'
                fill-rule='evenodd'
