  ...
  return (
    <footer className='bottom-0 w-full text-center py-[60px] bg-[#242424] text-primary  relative px-4 md:pb-4'>
      <div className='flex flex-col gap-5 md:px-[146px]'>
        <img
          className='absolute  bottom-0 left-0 z-0 -translate-x-[11.75rem] -translate-y-[315px] md:-translate-y-[140px] md:-translate-x-[370px]  '
          src={ringpattern}
        />
      ...
      <div className='w-full border-t-2 border-primary mt-[68px] pt-9 md:mt-[92px] md:pt-[30px]'>
        <Navbar />
      </div>
    </footer>
  );
